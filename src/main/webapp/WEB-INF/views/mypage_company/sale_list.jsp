				...
				<div class="row">
					...
					<div class="col-lg-10">
						<div class="section-title mb-0">
							<h4 class="m-0 text-uppercase font-weight-bold">판매 입찰 목록</h4>
						</div>
							...
							<div class="mb-4">
								<div class="mb-3">
									<div class="d-flex align-items-center mb-2">
										...
										<h6 class="font-weight-bold mb-0">판매 입찰 목록</h6>
									</div>
											...
											<tbody>
												<c:forEach items="${list}" var="list">
													<tr class="active-row">
														<td>${list.sell_bno}</td>
														<td><a
															href="/sell_board/sell_view?sell_bno=${list.sell_bno}">${list.sell_title}</a></td>
														<td><fmt:formatDate value="${list.sell_regDate}" pattern="yyyy-MM-dd" /></td>
														<td>${list.sell_people}명</td>
														<td style="color: gray;"><fmt:formatNumber pattern="###,###,###" value="${list.sell_price}" /> 원</td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
